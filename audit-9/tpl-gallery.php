...
<title>Gallery — Table for All</title>
...
.hero .overlay{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(0,0,0,.50) 0%,rgba(0,0,0,.80) 100%)}
