...
.hero .overlay{position:absolute;inset:0;background:linear-gradient(135deg,rgba(28,17,8,.35) 0%,rgba(28,17,8,.15) 100%)}
...
<section class="hero hero-sm">
  <div class="bg" style="background-image:url('https://ernien.sg-host.com/wp-content/uploads/2026/03/tfa/hero-about-new.jpg');background-size:cover;background-position:center"></div>
